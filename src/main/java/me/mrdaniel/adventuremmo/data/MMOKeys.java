...
public class MMOKeys {
	...
	// SuperToolData
	public static final Key<ListValue<Enchantment>> ENCHANTS = KeyFactory.makeListKey(new TypeToken<List<Enchantment>>(){}, new TypeToken<ListValue<Enchantment>>(){}, DataQuery.of("enchants"), "mmo:enchants", "MMO Enchants");
